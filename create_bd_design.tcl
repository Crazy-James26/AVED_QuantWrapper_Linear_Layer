...
proc create_hier_cell_clock_reset { parentCell nameHier } {
  ...
  set_property -dict [list \
    ...
    CONFIG.CLKOUT_REQUESTED_OUT_FREQUENCY {250,600} \
...
proc create_hier_cell_base_logic { parentCell nameHier } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins pcie_slr0_mgmt_sc/M04_AXI] [get_bd_intf_pins M04_AXI]
  ...
  # Create port connections
  connect_bd_net -net aclk1_1 [get_bd_pins aclk1] [get_bd_pins pcie_slr0_mgmt_sc/aclk1]
...
24.000 HBM_PC1_SCRUB_START_ADDRESS 0x0000000 HBM_PC1_SCRUB_END_ADDRESS 0x3FFFBFF HBM_PC1_SCRUB_INTERVAL 24.000} \
  ...
  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM0_PORT0 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM00_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM0_PORT1 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM01_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM0_PORT2 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM02_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM0_PORT3 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM03_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM1_PORT0 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM04_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM1_PORT1 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM05_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM1_PORT2 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM06_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM1_PORT3 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM07_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM2_PORT0 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM08_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM2_PORT1 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM09_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM2_PORT2 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM10_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM2_PORT3 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM11_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM3_PORT0 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM12_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM3_PORT1 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM13_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM3_PORT2 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM14_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM3_PORT3 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM15_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM4_PORT0 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM16_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM4_PORT1 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM17_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM4_PORT2 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM18_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM4_PORT3 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM19_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM5_PORT0 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM20_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM5_PORT1 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM21_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM5_PORT2 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM22_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM5_PORT3 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM23_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM6_PORT0 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM24_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM6_PORT1 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM25_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM6_PORT2 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM26_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM6_PORT3 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM27_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM7_PORT0 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM28_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM7_PORT1 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM29_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM7_PORT2 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM30_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM7_PORT3 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM31_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM8_PORT0 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM32_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM8_PORT1 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM33_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM8_PORT2 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM34_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM8_PORT3 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM35_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM9_PORT0 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM36_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM9_PORT1 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM37_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM9_PORT2 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM38_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM9_PORT3 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM39_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM10_PORT0 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM40_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM10_PORT1 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM41_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM10_PORT2 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM42_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM10_PORT3 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM43_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM11_PORT0 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM44_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM11_PORT1 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM45_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM11_PORT2 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM46_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM11_PORT3 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM47_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM12_PORT0 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM48_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM12_PORT1 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM49_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM12_PORT2 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM50_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM12_PORT3 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM51_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM13_PORT0 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM52_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM13_PORT1 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM53_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM13_PORT2 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM54_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM13_PORT3 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM55_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM14_PORT0 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM56_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM14_PORT1 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM57_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM14_PORT2 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM58_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM14_PORT3 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM59_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM15_PORT0 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM60_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM15_PORT1 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM61_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM15_PORT2 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM62_AXI]

  set_property -dict [ list \
   CONFIG.CONNECTIONS { HBM15_PORT3 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl_hbm} \
 ] [get_bd_intf_pins /axi_noc_cips/HBM63_AXI]
  ...
  set_property -dict [ list \
   ...
   CONFIG.DEST_IDS {M00_AXI:0x140:M01_AXI:0x40:M02_AXI:0x80:M03_AXI:0x101} \
  ...
  set_property -dict [ list \
   CONFIG.CONNECTIONS { MC_2 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl} \
  ...
  set_property -dict [ list \
   CONFIG.CONNECTIONS { MC_3 { read_bw {12800} write_bw {12800} read_avg_burst {128} write_avg_burst {128}} } \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl} \
 ...
 ] [get_bd_pins /axi_noc_mc_ddr4_1/aclk1]
  ...
  # Create instance: SpinQuant_Decoding_0, and set properties
  set SpinQuant_Decoding_0 [ create_bd_cell -type ip -vlnv haoda:xrtl:SpinQuant_Decoding SpinQuant_Decoding_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_R1_R1N_mmaps_0 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_R1_R1N_mmaps_0] [get_bd_intf_pins axi_noc_cips/HBM00_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_R1_R1N_mmaps_1 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_R1_R1N_mmaps_1] [get_bd_intf_pins axi_noc_cips/HBM01_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_R1_R1N_mmaps_2 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_R1_R1N_mmaps_2] [get_bd_intf_pins axi_noc_cips/HBM02_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_R1_R1N_mmaps_3 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_R1_R1N_mmaps_3] [get_bd_intf_pins axi_noc_cips/HBM03_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_R1_R1N_mmaps_4 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_R1_R1N_mmaps_4] [get_bd_intf_pins axi_noc_cips/HBM04_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_R1_R1N_mmaps_5 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_R1_R1N_mmaps_5] [get_bd_intf_pins axi_noc_cips/HBM05_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_R1_R1N_mmaps_6 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_R1_R1N_mmaps_6] [get_bd_intf_pins axi_noc_cips/HBM06_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_R1_R1N_mmaps_7 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_R1_R1N_mmaps_7] [get_bd_intf_pins axi_noc_cips/HBM07_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_gamma_beta_mmap [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_gamma_beta_mmap] [get_bd_intf_pins axi_noc_cips/HBM34_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_io_mmap [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_io_mmap] [get_bd_intf_pins axi_noc_cips/HBM32_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_k_caches_0 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_k_caches_0] [get_bd_intf_pins axi_noc_cips/HBM08_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_k_caches_1 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_k_caches_1] [get_bd_intf_pins axi_noc_cips/HBM09_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_k_caches_2 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_k_caches_2] [get_bd_intf_pins axi_noc_cips/HBM10_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_k_caches_3 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_k_caches_3] [get_bd_intf_pins axi_noc_cips/HBM11_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_k_caches_4 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_k_caches_4] [get_bd_intf_pins axi_noc_cips/HBM12_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_k_caches_5 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_k_caches_5] [get_bd_intf_pins axi_noc_cips/HBM13_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_k_caches_6 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_k_caches_6] [get_bd_intf_pins axi_noc_cips/HBM14_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_k_caches_7 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_k_caches_7] [get_bd_intf_pins axi_noc_cips/HBM15_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_rand_seeds_mmap [get_bd_intf_pins axi_noc_mc_ddr4_1/S01_AXI] [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_rand_seeds_mmap]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_v_caches_0 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_v_caches_0] [get_bd_intf_pins axi_noc_cips/HBM36_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_v_caches_1 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_v_caches_1] [get_bd_intf_pins axi_noc_cips/HBM37_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_v_caches_2 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_v_caches_2] [get_bd_intf_pins axi_noc_cips/HBM38_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_v_caches_3 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_v_caches_3] [get_bd_intf_pins axi_noc_cips/HBM39_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_v_caches_4 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_v_caches_4] [get_bd_intf_pins axi_noc_cips/HBM40_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_v_caches_5 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_v_caches_5] [get_bd_intf_pins axi_noc_cips/HBM41_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_v_caches_6 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_v_caches_6] [get_bd_intf_pins axi_noc_cips/HBM42_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_v_caches_7 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_v_caches_7] [get_bd_intf_pins axi_noc_cips/HBM43_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_vocab_lib [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_vocab_lib] [get_bd_intf_pins axi_noc_mc_ddr4_1/S00_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_qkvo_FFN_mmaps_0 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_0] [get_bd_intf_pins axi_noc_cips/HBM16_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_qkvo_FFN_mmaps_1 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_1] [get_bd_intf_pins axi_noc_cips/HBM17_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_qkvo_FFN_mmaps_2 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_2] [get_bd_intf_pins axi_noc_cips/HBM18_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_qkvo_FFN_mmaps_3 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_3] [get_bd_intf_pins axi_noc_cips/HBM19_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_qkvo_FFN_mmaps_4 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_4] [get_bd_intf_pins axi_noc_cips/HBM20_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_qkvo_FFN_mmaps_5 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_5] [get_bd_intf_pins axi_noc_cips/HBM21_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_qkvo_FFN_mmaps_6 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_6] [get_bd_intf_pins axi_noc_cips/HBM22_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_qkvo_FFN_mmaps_7 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_7] [get_bd_intf_pins axi_noc_cips/HBM23_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_qkvo_FFN_mmaps_8 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_8] [get_bd_intf_pins axi_noc_cips/HBM24_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_qkvo_FFN_mmaps_9 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_9] [get_bd_intf_pins axi_noc_cips/HBM25_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_qkvo_FFN_mmaps_10 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_10] [get_bd_intf_pins axi_noc_cips/HBM26_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_qkvo_FFN_mmaps_11 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_11] [get_bd_intf_pins axi_noc_cips/HBM27_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_qkvo_FFN_mmaps_12 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_12] [get_bd_intf_pins axi_noc_cips/HBM28_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_qkvo_FFN_mmaps_13 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_13] [get_bd_intf_pins axi_noc_cips/HBM29_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_qkvo_FFN_mmaps_14 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_14] [get_bd_intf_pins axi_noc_cips/HBM30_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_qkvo_FFN_mmaps_15 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_15] [get_bd_intf_pins axi_noc_cips/HBM31_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_qkvo_FFN_mmaps_16 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_16] [get_bd_intf_pins axi_noc_cips/HBM44_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_qkvo_FFN_mmaps_17 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_17] [get_bd_intf_pins axi_noc_cips/HBM45_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_qkvo_FFN_mmaps_18 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_18] [get_bd_intf_pins axi_noc_cips/HBM46_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_qkvo_FFN_mmaps_19 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_19] [get_bd_intf_pins axi_noc_cips/HBM47_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_qkvo_FFN_mmaps_20 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_20] [get_bd_intf_pins axi_noc_cips/HBM48_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_qkvo_FFN_mmaps_21 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_21] [get_bd_intf_pins axi_noc_cips/HBM49_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_qkvo_FFN_mmaps_22 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_22] [get_bd_intf_pins axi_noc_cips/HBM50_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_qkvo_FFN_mmaps_23 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_23] [get_bd_intf_pins axi_noc_cips/HBM51_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_qkvo_FFN_mmaps_24 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_24] [get_bd_intf_pins axi_noc_cips/HBM52_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_qkvo_FFN_mmaps_25 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_25] [get_bd_intf_pins axi_noc_cips/HBM53_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_qkvo_FFN_mmaps_26 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_26] [get_bd_intf_pins axi_noc_cips/HBM54_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_qkvo_FFN_mmaps_27 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_27] [get_bd_intf_pins axi_noc_cips/HBM55_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_qkvo_FFN_mmaps_28 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_28] [get_bd_intf_pins axi_noc_cips/HBM56_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_qkvo_FFN_mmaps_29 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_29] [get_bd_intf_pins axi_noc_cips/HBM57_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_qkvo_FFN_mmaps_30 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_30] [get_bd_intf_pins axi_noc_cips/HBM58_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_qkvo_FFN_mmaps_31 [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_31] [get_bd_intf_pins axi_noc_cips/HBM59_AXI]
  connect_bd_intf_net -intf_net SpinQuant_Decoding_0_m_axi_w_s_sum_qkvo_FFN_mmap [get_bd_intf_pins SpinQuant_Decoding_0/m_axi_w_s_sum_qkvo_FFN_mmap] [get_bd_intf_pins axi_noc_cips/HBM60_AXI]
  ...
  connect_bd_intf_net -intf_net base_logic_M04_AXI [get_bd_intf_pins SpinQuant_Decoding_0/s_axi_control] [get_bd_intf_pins base_logic/M04_AXI]
  ...
  # Create port connections
  connect_bd_net -net SpinQuant_Decoding_0_interrupt [get_bd_pins SpinQuant_Decoding_0/interrupt] [get_bd_pins cips/pl_ps_irq1]
  ...
  connect_bd_net -net clock_reset_clk_usr_0 [get_bd_pins clock_reset/clk_usr_0] [get_bd_pins axi_noc_mc_ddr4_1/aclk1] [get_bd_pins axi_noc_cips/aclk5] [get_bd_pins SpinQuant_Decoding_0/ap_clk] [get_bd_pins base_logic/aclk1]
  ...
  connect_bd_net -net clock_reset_resetn_usr_0_periph [get_bd_pins clock_reset/resetn_usr_0_periph] [get_bd_pins SpinQuant_Decoding_0/ap_rst_n]

  # Create address segments
  assign_bd_address -offset 0x020100000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces cips/CPM_PCIE_NOC_0] [get_bd_addr_segs SpinQuant_Decoding_0/s_axi_control/reg0] -force
  ...
  assign_bd_address -offset 0x020100000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces cips/CPM_PCIE_NOC_1] [get_bd_addr_segs SpinQuant_Decoding_0/s_axi_control/reg0] -force
  ...
  assign_bd_address -offset 0x004000000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_R1_R1N_mmaps_0] [get_bd_addr_segs axi_noc_cips/HBM00_AXI/HBM0_PC0] -force
  assign_bd_address -offset 0x004000000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_R1_R1N_mmaps_1] [get_bd_addr_segs axi_noc_cips/HBM01_AXI/HBM0_PC0] -force
  assign_bd_address -offset 0x004040000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_R1_R1N_mmaps_2] [get_bd_addr_segs axi_noc_cips/HBM02_AXI/HBM0_PC1] -force
  assign_bd_address -offset 0x004040000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_R1_R1N_mmaps_3] [get_bd_addr_segs axi_noc_cips/HBM03_AXI/HBM0_PC1] -force
  assign_bd_address -offset 0x004080000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_R1_R1N_mmaps_4] [get_bd_addr_segs axi_noc_cips/HBM04_AXI/HBM1_PC0] -force
  assign_bd_address -offset 0x004080000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_R1_R1N_mmaps_5] [get_bd_addr_segs axi_noc_cips/HBM05_AXI/HBM1_PC0] -force
  assign_bd_address -offset 0x0040C0000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_R1_R1N_mmaps_6] [get_bd_addr_segs axi_noc_cips/HBM06_AXI/HBM1_PC1] -force
  assign_bd_address -offset 0x0040C0000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_R1_R1N_mmaps_7] [get_bd_addr_segs axi_noc_cips/HBM07_AXI/HBM1_PC1] -force
  assign_bd_address -offset 0x004440000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_gamma_beta_mmap] [get_bd_addr_segs axi_noc_cips/HBM34_AXI/HBM8_PC1] -force
  assign_bd_address -offset 0x004400000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_io_mmap] [get_bd_addr_segs axi_noc_cips/HBM32_AXI/HBM8_PC0] -force
  assign_bd_address -offset 0x004100000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_k_caches_0] [get_bd_addr_segs axi_noc_cips/HBM08_AXI/HBM2_PC0] -force
  assign_bd_address -offset 0x004100000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_k_caches_1] [get_bd_addr_segs axi_noc_cips/HBM09_AXI/HBM2_PC0] -force
  assign_bd_address -offset 0x004140000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_k_caches_2] [get_bd_addr_segs axi_noc_cips/HBM10_AXI/HBM2_PC1] -force
  assign_bd_address -offset 0x004140000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_k_caches_3] [get_bd_addr_segs axi_noc_cips/HBM11_AXI/HBM2_PC1] -force
  assign_bd_address -offset 0x004180000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_k_caches_4] [get_bd_addr_segs axi_noc_cips/HBM12_AXI/HBM3_PC0] -force
  assign_bd_address -offset 0x004180000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_k_caches_5] [get_bd_addr_segs axi_noc_cips/HBM13_AXI/HBM3_PC0] -force
  assign_bd_address -offset 0x0041C0000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_k_caches_6] [get_bd_addr_segs axi_noc_cips/HBM14_AXI/HBM3_PC1] -force
  assign_bd_address -offset 0x0041C0000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_k_caches_7] [get_bd_addr_segs axi_noc_cips/HBM15_AXI/HBM3_PC1] -force
  assign_bd_address -offset 0x060000000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_rand_seeds_mmap] [get_bd_addr_segs axi_noc_mc_ddr4_1/S01_AXI/C3_DDR_CH2] -force
  assign_bd_address -offset 0x004480000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_v_caches_0] [get_bd_addr_segs axi_noc_cips/HBM36_AXI/HBM9_PC0] -force
  assign_bd_address -offset 0x004480000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_v_caches_1] [get_bd_addr_segs axi_noc_cips/HBM37_AXI/HBM9_PC0] -force
  assign_bd_address -offset 0x0044C0000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_v_caches_2] [get_bd_addr_segs axi_noc_cips/HBM38_AXI/HBM9_PC1] -force
  assign_bd_address -offset 0x0044C0000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_v_caches_3] [get_bd_addr_segs axi_noc_cips/HBM39_AXI/HBM9_PC1] -force
  assign_bd_address -offset 0x004500000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_v_caches_4] [get_bd_addr_segs axi_noc_cips/HBM40_AXI/HBM10_PC0] -force
  assign_bd_address -offset 0x004500000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_v_caches_5] [get_bd_addr_segs axi_noc_cips/HBM41_AXI/HBM10_PC0] -force
  assign_bd_address -offset 0x004540000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_v_caches_6] [get_bd_addr_segs axi_noc_cips/HBM42_AXI/HBM10_PC1] -force
  assign_bd_address -offset 0x004540000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_v_caches_7] [get_bd_addr_segs axi_noc_cips/HBM43_AXI/HBM10_PC1] -force
  assign_bd_address -offset 0x060000000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_vocab_lib] [get_bd_addr_segs axi_noc_mc_ddr4_1/S00_AXI/C2_DDR_CH2] -force
  assign_bd_address -offset 0x004200000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_0] [get_bd_addr_segs axi_noc_cips/HBM16_AXI/HBM4_PC0] -force
  assign_bd_address -offset 0x004200000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_1] [get_bd_addr_segs axi_noc_cips/HBM17_AXI/HBM4_PC0] -force
  assign_bd_address -offset 0x004340000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_10] [get_bd_addr_segs axi_noc_cips/HBM26_AXI/HBM6_PC1] -force
  assign_bd_address -offset 0x004340000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_11] [get_bd_addr_segs axi_noc_cips/HBM27_AXI/HBM6_PC1] -force
  assign_bd_address -offset 0x004380000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_12] [get_bd_addr_segs axi_noc_cips/HBM28_AXI/HBM7_PC0] -force
  assign_bd_address -offset 0x004380000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_13] [get_bd_addr_segs axi_noc_cips/HBM29_AXI/HBM7_PC0] -force
  assign_bd_address -offset 0x0043C0000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_14] [get_bd_addr_segs axi_noc_cips/HBM30_AXI/HBM7_PC1] -force
  assign_bd_address -offset 0x0043C0000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_15] [get_bd_addr_segs axi_noc_cips/HBM31_AXI/HBM7_PC1] -force
  assign_bd_address -offset 0x004240000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_2] [get_bd_addr_segs axi_noc_cips/HBM18_AXI/HBM4_PC1] -force
  assign_bd_address -offset 0x004240000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_3] [get_bd_addr_segs axi_noc_cips/HBM19_AXI/HBM4_PC1] -force
  assign_bd_address -offset 0x004280000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_4] [get_bd_addr_segs axi_noc_cips/HBM20_AXI/HBM5_PC0] -force
  assign_bd_address -offset 0x004280000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_5] [get_bd_addr_segs axi_noc_cips/HBM21_AXI/HBM5_PC0] -force
  assign_bd_address -offset 0x0042C0000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_6] [get_bd_addr_segs axi_noc_cips/HBM22_AXI/HBM5_PC1] -force
  assign_bd_address -offset 0x0042C0000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_7] [get_bd_addr_segs axi_noc_cips/HBM23_AXI/HBM5_PC1] -force
  assign_bd_address -offset 0x004300000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_8] [get_bd_addr_segs axi_noc_cips/HBM24_AXI/HBM6_PC0] -force
  assign_bd_address -offset 0x004300000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_9] [get_bd_addr_segs axi_noc_cips/HBM25_AXI/HBM6_PC0] -force
  assign_bd_address -offset 0x004580000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_16] [get_bd_addr_segs axi_noc_cips/HBM44_AXI/HBM11_PC0] -force
  assign_bd_address -offset 0x004580000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_17] [get_bd_addr_segs axi_noc_cips/HBM45_AXI/HBM11_PC0] -force
  assign_bd_address -offset 0x0046C0000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_26] [get_bd_addr_segs axi_noc_cips/HBM54_AXI/HBM13_PC1] -force
  assign_bd_address -offset 0x0046C0000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_27] [get_bd_addr_segs axi_noc_cips/HBM55_AXI/HBM13_PC1] -force
  assign_bd_address -offset 0x004700000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_28] [get_bd_addr_segs axi_noc_cips/HBM56_AXI/HBM14_PC0] -force
  assign_bd_address -offset 0x004700000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_29] [get_bd_addr_segs axi_noc_cips/HBM57_AXI/HBM14_PC0] -force
  assign_bd_address -offset 0x004740000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_30] [get_bd_addr_segs axi_noc_cips/HBM58_AXI/HBM14_PC1] -force
  assign_bd_address -offset 0x004740000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_31] [get_bd_addr_segs axi_noc_cips/HBM59_AXI/HBM14_PC1] -force
  assign_bd_address -offset 0x0045C0000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_18] [get_bd_addr_segs axi_noc_cips/HBM46_AXI/HBM11_PC1] -force
  assign_bd_address -offset 0x0045C0000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_19] [get_bd_addr_segs axi_noc_cips/HBM47_AXI/HBM11_PC1] -force
  assign_bd_address -offset 0x004600000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_20] [get_bd_addr_segs axi_noc_cips/HBM48_AXI/HBM12_PC0] -force
  assign_bd_address -offset 0x004600000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_21] [get_bd_addr_segs axi_noc_cips/HBM49_AXI/HBM12_PC0] -force
  assign_bd_address -offset 0x004640000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_22] [get_bd_addr_segs axi_noc_cips/HBM50_AXI/HBM12_PC1] -force
  assign_bd_address -offset 0x004640000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_23] [get_bd_addr_segs axi_noc_cips/HBM51_AXI/HBM12_PC1] -force
  assign_bd_address -offset 0x004680000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_24] [get_bd_addr_segs axi_noc_cips/HBM52_AXI/HBM13_PC0] -force
  assign_bd_address -offset 0x004680000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_qkvo_FFN_mmaps_25] [get_bd_addr_segs axi_noc_cips/HBM53_AXI/HBM13_PC0] -force
  assign_bd_address -offset 0x004780000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces SpinQuant_Decoding_0/m_axi_w_s_sum_qkvo_FFN_mmap] [get_bd_addr_segs axi_noc_cips/HBM60_AXI/HBM15_PC0] -force
