...
module __rs_pt_control_s_axi_U_2 #(
...
__rs_pass_through #(
    .WIDTH (1)
) __rs_pt_QuantWrapper_Linear_Layer_q_tb_control_s_axi_BREADY_inst /**   Generated by RapidStream   **/ (
    .din  (BREADY),
    .dout (__rs_pt_BREADY)
);
...
__rs_pass_through #(
    .WIDTH (2)
) __rs_pt_QuantWrapper_Linear_Layer_q_tb_control_s_axi_BRESP_inst /**   Generated by RapidStream   **/ (
    .din  (__rs_pt_BRESP),
    .dout (BRESP)
);
...
__rs_pass_through #(
    .WIDTH (1)
) __rs_pt_QuantWrapper_Linear_Layer_q_tb_control_s_axi_BVALID_inst /**   Generated by RapidStream   **/ (
    .din  (__rs_pt_BVALID),
    .dout (BVALID)
);

endmodule  // __rs_pt_control_s_axi_U_2