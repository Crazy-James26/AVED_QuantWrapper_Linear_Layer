...
module Linear_Layer_i4xi4_q_PE_i4xi4_pack_2x2_true_11_false_false_39_Pipeline_PE_LOOP (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    A_fifo_2_6_read_local;
reg    B_fifo_6_2_read_local;
reg    ap_block_pp0_stage0_01001;
reg    A_fifo_2_7_write_local;
reg    B_fifo_6_3_write_local;
...
Linear_Layer_i4xi4_q_mac_muladd_24s_4ns_38s_38_4_1 #(
    ...
    .din2_WIDTH( 38 ),
    .dout_WIDTH( 38 ))
mac_muladd_24s_4ns_38s_38_4_1_U554(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_338_p0),
    .din1(grp_fu_338_p1),
...
Linear_Layer_i4xi4_q_mac_muladd_24s_4ns_38s_38_4_1 #(
    ...
    .din2_WIDTH( 38 ),
    .dout_WIDTH( 38 ))
mac_muladd_24s_4ns_38s_38_4_1_U555(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_350_p0),
    .din1(grp_fu_350_p1),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        a1_reg_397 <= {{A_fifo_2_6_dout[7:4]}};
        ap_loop_exit_ready_pp0_iter1_reg <= ap_loop_exit_ready;
        ap_loop_exit_ready_pp0_iter2_reg <= ap_loop_exit_ready_pp0_iter1_reg;
        b0_reg_402 <= b0_fu_194_p1;
        b0_sign_ex_reg_412 <= B_fifo_6_2_dout[32'd3];
        b1_reg_407 <= {{B_fifo_6_2_dout[7:4]}};
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        A_fifo_2_6_read_local = 1'b1;
    end else begin
        A_fifo_2_6_read_local = 1'b0;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        A_fifo_2_7_write_local = 1'b1;
    end else begin
        A_fifo_2_7_write_local = 1'b0;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        B_fifo_6_2_read_local = 1'b1;
    end else begin
        B_fifo_6_2_read_local = 1'b0;
    end
end
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        B_fifo_6_3_write_local = 1'b1;
    end else begin
        B_fifo_6_3_write_local = 1'b0;
    end
end
always @ (*) begin
...
assign A_fifo_2_6_read = A_fifo_2_6_read_local;
assign A_fifo_2_7_din = A_fifo_2_6_dout;
assign A_fifo_2_7_write = A_fifo_2_7_write_local;
assign B_fifo_6_2_read = B_fifo_6_2_read_local;
assign B_fifo_6_3_din = B_fifo_6_2_dout;
assign B_fifo_6_3_write = B_fifo_6_3_write_local;
assign a0_fu_178_p1 = A_fifo_2_6_dout[3:0];
...
always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((1'b0 == B_fifo_6_3_full_n) | (1'b0 == A_fifo_2_7_full_n) | (1'b0 == B_fifo_6_2_empty_n) | (1'b0 == A_fifo_2_6_empty_n));
end
...
assign b0_fu_194_p1 = B_fifo_6_2_dout[3:0];
assign b1_temp_88_fu_251_p3 = ((b0_sign_ex_reg_412[0:0] == 1'b1) ? b1_temp_fu_245_p2 : sext_ln1441_fu_242_p1);
...
assign pack_b_fu_265_p4 = {{{b1_temp_88_fu_251_p3}, {select_ln1442_fu_258_p3}}, {b0_reg_402}};
