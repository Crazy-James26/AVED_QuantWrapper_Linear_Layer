...
// ==================================================
`timescale 1 ns / 1 ps
module quant_layer_r1_ln_iembed_fp32_int4 #(
    ...
    input wire          ap_rst_n,
    input wire          ap_start,
    input wire  [ 64:0] input_s_b_stream_peek,
    output wire [ 64:0] input_s_b_stream_s_din,
    input wire          input_s_b_stream_s_full_n,
    output wire         input_s_b_stream_s_write,
    input wire  [512:0] input_stream_peek_dout,
    input wire          input_stream_peek_empty_n,
    output wire         input_stream_peek_read,
    input wire  [512:0] input_stream_s_dout,
...
quant_layer_r1_ln_iembed_fp32_int4_hide_peek #(
    .ap_ST_fsm_state1 (ap_ST_fsm_state1),
    .ap_ST_fsm_state2 (ap_ST_fsm_state2),
    .ap_ST_fsm_state3 (ap_ST_fsm_state3)
) quant_layer_r1_ln_iembed_fp32_int4_hide_peek_0 /**   Generated by RapidStream   **/ (
    .ap_clk                    (ap_clk),
    .ap_done                   (ap_done),
    .ap_idle                   (ap_idle),
    .ap_ready                  (ap_ready),
    .ap_rst_n                  (ap_rst_n),
    .ap_start                  (ap_start),
    .input_s_b_stream_peek     (input_s_b_stream_peek),
    .input_s_b_stream_s_din    (input_s_b_stream_s_din),
    .input_s_b_stream_s_full_n (input_s_b_stream_s_full_n),
    .input_s_b_stream_s_write  (input_s_b_stream_s_write),
...
endmodule  // quant_layer_r1_ln_iembed_fp32_int4