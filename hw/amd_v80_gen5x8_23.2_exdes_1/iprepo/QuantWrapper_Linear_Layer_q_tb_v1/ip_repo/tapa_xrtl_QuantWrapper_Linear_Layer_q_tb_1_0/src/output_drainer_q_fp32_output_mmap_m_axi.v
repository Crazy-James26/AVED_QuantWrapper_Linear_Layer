...
module output_drainer_q_fp32_output_mmap_m_axi
#(parameter
    CONSERVATIVE            = 0,
...
//------------------------Instantiation------------------
    // output_drainer_q_fp32_output_mmap_m_axi_store
    output_drainer_q_fp32_output_mmap_m_axi_store #(
    ...
    output_drainer_q_fp32_output_mmap_m_axi_load #(
        .C_TARGET_ADDR           ( C_TARGET_ADDR ),
    ...
    // output_drainer_q_fp32_output_mmap_m_axi_write
    output_drainer_q_fp32_output_mmap_m_axi_write #(
    ...
    // output_drainer_q_fp32_output_mmap_m_axi_read
    output_drainer_q_fp32_output_mmap_m_axi_read #(
        .C_M_AXI_ID_WIDTH         ( C_M_AXI_ID_WIDTH ),
