...
module weight_s_loader_wq_weight_s_sum_mmap_m_axi
#(parameter
    CONSERVATIVE            = 0,
...
//------------------------Instantiation------------------
    // weight_s_loader_wq_weight_s_sum_mmap_m_axi_store
    weight_s_loader_wq_weight_s_sum_mmap_m_axi_store #(
    ...
    weight_s_loader_wq_weight_s_sum_mmap_m_axi_load #(
        .C_TARGET_ADDR           ( C_TARGET_ADDR ),
    ...
    // weight_s_loader_wq_weight_s_sum_mmap_m_axi_write
    weight_s_loader_wq_weight_s_sum_mmap_m_axi_write #(
    ...
    // weight_s_loader_wq_weight_s_sum_mmap_m_axi_read
    weight_s_loader_wq_weight_s_sum_mmap_m_axi_read #(
        .C_M_AXI_ID_WIDTH         ( C_M_AXI_ID_WIDTH ),
