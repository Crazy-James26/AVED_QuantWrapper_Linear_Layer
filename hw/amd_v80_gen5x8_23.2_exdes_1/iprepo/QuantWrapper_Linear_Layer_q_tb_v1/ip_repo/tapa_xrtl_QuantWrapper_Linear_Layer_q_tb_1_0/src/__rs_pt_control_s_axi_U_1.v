...
) __rs_pt_QuantWrapper_Linear_Layer_q_tb_control_s_axi_AWADDR_inst /**   Generated by RapidStream   **/ (
    .din  (AWADDR),
    .dout (__rs_pt_AWADDR)
);
...
__rs_pass_through #(
    .WIDTH (1)
) __rs_pt_QuantWrapper_Linear_Layer_q_tb_control_s_axi_AWREADY_inst /**   Generated by RapidStream   **/ (
    .din  (__rs_pt_AWREADY),
    .dout (AWREADY)
);
...
__rs_pass_through #(
    .WIDTH (1)
) __rs_pt_QuantWrapper_Linear_Layer_q_tb_control_s_axi_AWVALID_inst /**   Generated by RapidStream   **/ (
    .din  (AWVALID),
