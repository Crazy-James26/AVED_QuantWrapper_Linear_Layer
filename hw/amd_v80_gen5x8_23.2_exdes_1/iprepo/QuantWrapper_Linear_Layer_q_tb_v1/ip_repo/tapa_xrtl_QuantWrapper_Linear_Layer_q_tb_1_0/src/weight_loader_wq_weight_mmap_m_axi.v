...
module weight_loader_wq_weight_mmap_m_axi
#(parameter
    CONSERVATIVE            = 0,
...
//------------------------Instantiation------------------
    // weight_loader_wq_weight_mmap_m_axi_store
    weight_loader_wq_weight_mmap_m_axi_store #(
    ...
    weight_loader_wq_weight_mmap_m_axi_load #(
        .C_TARGET_ADDR           ( C_TARGET_ADDR ),
    ...
    // weight_loader_wq_weight_mmap_m_axi_write
    weight_loader_wq_weight_mmap_m_axi_write #(
    ...
    // weight_loader_wq_weight_mmap_m_axi_read
    weight_loader_wq_weight_mmap_m_axi_read #(
        .C_M_AXI_ID_WIDTH         ( C_M_AXI_ID_WIDTH ),
