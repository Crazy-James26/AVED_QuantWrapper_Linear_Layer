...
haoda:xrtl:QuantWrapper_Linear_Layer_q_tb:*\
...
\
  ...
  set_property -dict [ list \
   CONFIG.CONNECTIONS {M02_INI {read_bw {800} write_bw {800} read_avg_burst {64} write_avg_burst {64}} M00_AXI {read_bw {5} write_bw {5} read_avg_burst {64} write_avg_burst {64}} M00_INI {read_bw {800} write_bw {800} read_avg_burst {64} write_avg_burst {64}}} \
  ...
  set_property -dict [ list \
   CONFIG.CONNECTIONS {M01_INI {read_bw {800} write_bw {800} read_avg_burst {64} write_avg_burst {64}} M03_INI {read_bw {800} write_bw {800} read_avg_burst {64} write_avg_burst {64}} M00_AXI {read_bw {5} write_bw {5} read_avg_burst {64} write_avg_burst {64}}} \
   CONFIG.DEST_IDS {M00_AXI:0x140} \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {ps_pcie} \
  ...
  # Create instance: QuantWrapper_Linear_0, and set properties
  set QuantWrapper_Linear_0 [ create_bd_cell -type ip -vlnv haoda:xrtl:QuantWrapper_Linear_Layer_q_tb QuantWrapper_Linear_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net QuantWrapper_Linear_0_m_axi_input_mmap [get_bd_intf_pins QuantWrapper_Linear_0/m_axi_input_mmap] [get_bd_intf_pins axi_noc_cips/S04_AXI]
  connect_bd_intf_net -intf_net QuantWrapper_Linear_0_m_axi_output_mmap [get_bd_intf_pins QuantWrapper_Linear_0/m_axi_output_mmap] [get_bd_intf_pins axi_noc_cips/S05_AXI]
  connect_bd_intf_net -intf_net QuantWrapper_Linear_0_m_axi_quant_weight_mmap [get_bd_intf_pins QuantWrapper_Linear_0/m_axi_quant_weight_mmap] [get_bd_intf_pins axi_noc_cips/S06_AXI]
  connect_bd_intf_net -intf_net QuantWrapper_Linear_0_m_axi_weight_s_sum_mmap [get_bd_intf_pins QuantWrapper_Linear_0/m_axi_weight_s_sum_mmap] [get_bd_intf_pins axi_noc_cips/S07_AXI]
  ...
  connect_bd_intf_net -intf_net base_logic_M04_AXI [get_bd_intf_pins QuantWrapper_Linear_0/s_axi_control] [get_bd_intf_pins base_logic/M04_AXI]
  ...
  # Create port connections
  connect_bd_net -net QuantWrapper_Linear_0_interrupt [get_bd_pins QuantWrapper_Linear_0/interrupt] [get_bd_pins cips/pl_ps_irq1]
  ...
  connect_bd_net -net clock_reset_clk_usr_0 [get_bd_pins clock_reset/clk_usr_0] [get_bd_pins QuantWrapper_Linear_0/ap_clk] [get_bd_pins axi_noc_cips/aclk5] [get_bd_pins base_logic/aclk1]
  ...
  connect_bd_net -net clock_reset_resetn_usr_0_periph [get_bd_pins clock_reset/resetn_usr_0_periph] [get_bd_pins QuantWrapper_Linear_0/ap_rst_n]

  # Create address segments
  assign_bd_address -offset 0x020100000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces cips/CPM_PCIE_NOC_0] [get_bd_addr_segs QuantWrapper_Linear_0/s_axi_control/reg0] -force
  ...
  assign_bd_address -offset 0x020100000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces cips/CPM_PCIE_NOC_1] [get_bd_addr_segs QuantWrapper_Linear_0/s_axi_control/reg0] -force
  ...
  assign_bd_address -offset 0x004000000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces QuantWrapper_Linear_0/m_axi_input_mmap] [get_bd_addr_segs axi_noc_cips/S04_AXI/HBM0_PC0] -force
  assign_bd_address -offset 0x004080000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces QuantWrapper_Linear_0/m_axi_output_mmap] [get_bd_addr_segs axi_noc_cips/S05_AXI/HBM1_PC0] -force
  assign_bd_address -offset 0x004100000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces QuantWrapper_Linear_0/m_axi_quant_weight_mmap] [get_bd_addr_segs axi_noc_cips/S06_AXI/HBM2_PC0] -force
  assign_bd_address -offset 0x004180000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces QuantWrapper_Linear_0/m_axi_weight_s_sum_mmap] [get_bd_addr_segs axi_noc_cips/S07_AXI/HBM3_PC0] -force
